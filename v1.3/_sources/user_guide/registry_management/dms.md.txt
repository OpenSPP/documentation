...
- Ensure that the DMS module {doc}`spp_dms </reference/modules/spp_dms>` is properly installed and activated. Note that the Change_request ({doc}`spp_change_request </reference/modules/spp_change_request>`) module automatically installs the DMS module. To learn installing optional modules, refer to the **Installing Additional Modules** section in the document: {doc}`../../getting_started/module_installation`.
...
![Dms configure id types](dms/dms_configure_id_types.png)

#### Create new document type  
Click **New** to create a new document type. Enter the name of the ID type, then click **Save** to apply the changes.  
![Dms modify document type](dms/Dms_modify_document_type.png)
...
![Dms files page](dms/dms_files_page.png)
...
![Dms download attachment from files](dms/dms_download_attachment_from_files.png)

Click on the document you wish to download and click on the download icon.  
![Dms download button](dms/dms_download_button.png)
...
![Dms select change request](dms/dms_select_change_request.png)
...
![Dms edit document attachment](dms/dms_edit_document_attachment.png)
...
![Dms set root directory](dms/dms_set_root_directory.png)

Click on the **Subdirectory** tab, then click on **Add a line**, then rename the subdirectory.  
![Dms create sub directory](dms/dms_create_sub_directory.png)
...
![Dms add parent directory](dms/dms_add_parent_directory.png)
...
![Dms sub directory upload](dms/dms_sub_directory_upload.png)
...
![Dms upload file modal](dms/dms_upload_file_modal.png)
