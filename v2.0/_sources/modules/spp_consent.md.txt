...
The OpenSPP Consent module enhances the functionality of the **spp_registry** and **spp_registry** modules by providing a framework for managing and tracking consents provided by registrants (both individuals and groups). This module is essential for ensuring compliance with data privacy regulations and maintaining ethical data management practices within social protection programs.
...
* **Consent Integration:** Seamlessly integrates with the registrant profiles in the **spp_registry** and **spp_registry** modules, providing direct access to consent information from the registrant's record.
