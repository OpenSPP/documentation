...
:alt: Entitlement item form showing a Condition Domain filter

The **Condition Domain** filter and **Amount** restrict this entitlement item to matching beneficiaries.
```
