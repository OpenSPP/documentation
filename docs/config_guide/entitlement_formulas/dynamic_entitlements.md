...
```{image} /_images/en-us/config_guide/entitlement_formulas/10-multiplier-field-configuration.png
...
```{image} /_images/en-us/config_guide/entitlement_formulas/11-multiple-dynamic-items.png
