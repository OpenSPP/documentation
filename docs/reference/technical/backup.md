...
**Infrastructure layer:** This layer focuses on the physical and virtual components of an IT environment, including servers, network equipment, and storage systems.
...
**Application layer:** The application layer encompasses the specific data and configurations of OpenSPP.
...
**Database layer:** This layer Involves protecting the data stored in databases.
