...
* **Group Membership Management**:  Integrate with the **spp_registry** module to seamlessly add the new farmer to the specified group upon approval.
...
* **[spp_farmer_registry](spp_farmer_registry)**: Leverages the farmer-specific data models and attributes to capture and store information about the new farmer.
