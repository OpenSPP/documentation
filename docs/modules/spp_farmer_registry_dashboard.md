...
* **[spp_farmer_registry](spp_farmer_registry)** : The dashboard module heavily relies on the data models and functionalities provided by [spp_farmer_registry](spp_farmer_registry). It fetches data about farmers, farm groups, land records, agricultural activities, and other relevant information from this core module.
* ****spp_registry**** : Utilizes this module to display data related to group memberships, such as the number of farmers belonging to different types of farmer groups. 
...
* ****spp_registry**** :  Indirectly depends on this module through its reliance on [spp_farmer_registry](spp_farmer_registry).  The core registrant data structures and relationships defined in **spp_registry** are essential for the dashboard's functionality.
* ****spp_registry**** :  Utilized indirectly to access and display information about different types of farmer groups, which are defined and managed by this module.
* ****spp_registry**** : Also indirectly relied upon to access and visualize data related to individual farmers, such as their demographic information and registration details. 
