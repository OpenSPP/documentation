...
2. ****spp_registry****: This module integrates with the individual registry to access and utilize individual-specific data, such as:
...
- **Seamless Data Flow:** Automatically retrieves the necessary individual-specific attributes from the **spp_registry** module during VC generation, streamlining the issuance workflow.
...
4. The module automatically fetches the individual's name, birthdate, and other relevant attributes from the **spp_registry** data.
