...
The OpenSPP-based Social Registry contains everything necessary to set up a foundational registry. It can be expanded with additional modules to suit specific needs. Read more about {doc}`module installation </get_started/modules/index>`.
