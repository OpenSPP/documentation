...
myst:
  html_meta:
    ...
    "description": "OpenSPP DRIMS product configuration for managing disaster response inventory, donations, requests, and dispatches"
    "keywords": "OpenSPP, DRIMS, disaster response, inventory management, humanitarian, emergency relief"
---
...
The OpenSPP DRIMS is an open-source product, built and supported by the OpenSPP community. Read more about {doc}`installing OpenSPP DRIMS </get_started/modules/drims_installation>`.
