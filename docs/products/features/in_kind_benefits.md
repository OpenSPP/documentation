...
* **[spp_entitlement_basket](/modules/spp_entitlement_basket.md)**: Mixed basket entitlements combining multiple benefit types including in-kind goods
* **[spp_pos](/modules/spp_pos.md)**: Point of Sale system for voucher redemption at retail locations
