...
- **Registries**: Specialized systems, such as {term}`Civil Registration<civil registration>` and Vital Statistics (CRVS) and social registries, that maintain comprehensive and official records.
