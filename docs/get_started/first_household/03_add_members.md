...
### 1. Create the Head of Household
...
Repeat steps 1-3 to create records for:
...
- Create individual records for family members
- Link individuals to a household
...
| Concept | Description |
|---------|-------------|
| **Individual** | A single person registered in the system |
...
Your administrator may need to configure member roles for your installation.

**Can't add members?**
Verify you have permission to edit group records. Contact your administrator if needed.

## Next Steps

Congratulations! You've successfully registered your first household with family members.

From here, you can:

- {doc}`/user_guide/registry/import_data` - Import multiple registrants from files
- {doc}`../first_program/index` - Enroll this household in a social protection program
- {doc}`/user_guide/registry/export_data` - Export registrant data for reporting
