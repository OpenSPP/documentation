...
|-------|-------|-------------|
| Name | Garcia Family | A name to identify this household |
| Kind | Household | Type of group |
...
- Create a new household (group) in the registry
...
| Concept | Description |
|---------|-------------|
| **Group** | A collection of individuals, typically a household or family |
...
Check that all required fields are filled in. Required fields typically have an asterisk (*) next to them.

**Group kind options not showing?**
