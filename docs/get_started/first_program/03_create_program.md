...
![Screenshot: Main menu with four-square icon and Programs option highlighted](/_images/get_started/first_program/03_create_program/1.png)

### 2. Create a New Program

Click the **Create** button in the top-left corner of the Programs list.

![Screenshot: Programs list view with Create button highlighted in top-left](/_images/get_started/first_program/03_create_program/2.png)
...
![Screenshot: Program creation form showing Program Name field filled with "Cash Transfer for Vulnerable Families" and Target Type set to "Group"](/_images/get_started/first_program/03_create_program/3.png)

### 4. Set the Currency

Scroll down to the **Currency** field and select **PHP - Philippine Peso** from the dropdown.

![Screenshot: Currency field showing PHP - Philippine Peso selected](/_images/get_started/first_program/03_create_program/4.png)
...
![Screenshot: Program form showing the four tabs: Configuration, Eligibility, Cycle Manager, Entitlement Manager](/_images/get_started/first_program/03_create_program/5.png)
...
![Screenshot: Lower portion of Configuration tab showing default settings](/_images/get_started/first_program/03_create_program/6.png)

### 7. Save the Program

Click the **Save** button in the top-left corner to create your program.

![Screenshot: Save button in top-left corner of program form](/_images/get_started/first_program/03_create_program/7.png)

You should see a success notification: "Program created successfully."

![Screenshot: Green success notification banner showing "Program created successfully"](/_images/get_started/first_program/03_create_program/8.png)
...
![Screenshot: Program page showing "Cash Transfer for Vulnerable Families" at top with Draft status badge](/_images/get_started/first_program/03_create_program/9.png)
...
![Screenshot: Programs list showing "Cash Transfer for Vulnerable Families" as a new program with Draft status](/_images/get_started/first_program/03_create_program/10.png)
