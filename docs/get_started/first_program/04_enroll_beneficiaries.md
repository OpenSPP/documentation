...
You will import and enroll beneficiaries into your program that are eligible based on the previously defined eligibility criteria.
...
You have created the program and you now want to import and enroll all the beneficiaries that are eligible according to your previously configured eligibility criteria.
