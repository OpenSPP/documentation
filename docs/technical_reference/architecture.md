...
The Data Layer is responsible for storing and managing the data generated by and used within the OpenSPP system. It consists of the following: - **Database:** The database stores structured data, such as program information, beneficiary records, and transaction data. It uses a relational database management system (RDBMS) such as PostgreSQL. - **Object Storage:** Object Storage is a component that stores unstructured data, such as images, documents, or other multimedia files. Currently, file storage has been used.
